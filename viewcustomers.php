...
<div class="main_div">
     ...
     <div class="navbar navbar-expand-md">
      ...
      <a href="index.php" class="navbar-brand font-weight-bold text-white text-center">THE SPARKS FOUNDATION BANK</a>
      ...
      <span class="navbar-toggler-icon" style="background:white;"></span>
       ...
       <div class="collapse navbar-collapse text-center" id="collapsenavbar">
          <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item">
                  <a href="index.php#contact" class="nav-link text-white">CONTACT US</a></li>    
               </ul>
        </div>
     </div>
